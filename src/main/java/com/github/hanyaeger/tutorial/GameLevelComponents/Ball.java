...
public class Ball extends DynamicCircleEntity implements Collided, Collider, Newtonian, SceneBorderTouchingWatcher {
    ...
    public void onCollision(Collider collider) {
        ...
        if((lowerLeftBall[0] >= upperLeftBallCollider[0] && lowerLeftBall[0] <= upperRightBallCollider[0]) || (lowerRightBall[0] <= upperRightBallCollider[0] && lowerRightBall[0] >= upperLeftBallCollider[0])){
